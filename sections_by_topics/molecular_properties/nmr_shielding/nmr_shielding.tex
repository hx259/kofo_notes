...
\begin{align}
    \dv{\mathcal{L}_{\text{MP2}}}{m _{K _{\beta}}}\Big|_{{\mathbf{m}_{K}=\mathbf{0}}} =& \pdv{\mathcal{L}_{\text{MP2}}}{m _{K _{\beta}}}\Big|_{{\mathbf{m}_{K}=\mathbf{0}}} + \sum_{bj}\left(\pdv{\mathcal{L}_{\text{MP2}}}{\kappa _{bj}}\right)\left(\pdv{\kappa _{bj}}{m _{K _{\beta}}}\right)\Big|_{{\mathbf{m}_{K}=\mathbf{0}}} \nonumber \\
    &+ \sum_{ai}\left(\pdv{\mathcal{L}_{\text{MP2}}}{z _{ai}}\right)\left(\pdv{z _{ai}}{m _{K _{\beta}}}\right)\Big|_{{\mathbf{m}_{K}=\mathbf{0}}} \nonumber \\
...
\end{align}
\textcolor{red}{note that need to turn $z _{ai}^{*}$ into $z _{ia}$... what about $z _{ia}$ block?} \\
